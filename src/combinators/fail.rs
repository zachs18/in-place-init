...
pub struct Fail<T: ?Sized + MetaSized, E> {
    meta: <T as Pointee>::Metadata,
    err: E,
}

impl<T: ?Sized + MetaSized, E> Fail<T, E> {
...
unsafe impl<T: ?Sized + MetaSized, E> PinInit<T> for Fail<T, E> {
    type Error = E;
...
unsafe impl<T: ?Sized + MetaSized, E> Init<T> for Fail<T, E> {}
